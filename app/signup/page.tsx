    ...
    return (
      <div className="fixed inset-0 flex items-center justify-center" style={{ background: "rgb(25,24,22)" }}>
        <div className="text-center max-w-[300px]">
          <div className="font-display text-t1 text-[22px] mb-3">Check your email</div>
          <p className="text-xs text-t3 leading-relaxed">
            We sent a confirmation link to <span className="text-t1">{email}</span>. Click it to activate your account.
          </p>
        </div>
      </div>
    );
    ...
    <div className="fixed inset-0 flex items-center justify-center" style={{ background: "rgb(25,24,22)" }}>
      <div className="w-full max-w-[340px]">
        <div className="text-center mb-8">
          ...
          <div className="text-xs text-t4">Create your account</div>
        </div>
        ...
        <p className="text-center text-2xs text-t4 mt-5">
          ...
          <a href="/login" className="text-t2 underline underline-offset-2">Sign in</a>
        </p>
      </div>
    </div>
  );
